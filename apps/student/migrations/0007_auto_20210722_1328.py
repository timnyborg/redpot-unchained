...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='student',
            name='ethnicity',
            field=models.ForeignKey(db_column='ethnicity', default=90, on_delete=django.db.models.deletion.DO_NOTHING, to='student.ethnicity', db_index=False),  # to: revert after MSSQL 1.1.1 fixed
        ),
