...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='parental_education', help_text='Do any of your parents (natural, adoptive, step- or guardians who brought you up) have any higher education qualifications, such as a degree, diploma or certificate of higher education?', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student.parentaleducation'),
        ),
        migrations.AddField(
            model_name='student',
