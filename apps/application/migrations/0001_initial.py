# Generated by Django 3.0.11 on 2021-02-16 15:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('module', '0005_auto_20210215_2008'),
        ('student', '__first__'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', models.ForeignKey(db_column='module', on_delete=django.db.models.deletion.DO_NOTHING, related_name='applications', related_query_name='application', to='module.Module')),
                ('student', models.ForeignKey(db_column='student', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='applications', related_query_name='application', to='student.Student')),
            ],
            options={
