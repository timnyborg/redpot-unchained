# Generated by Django 3.2.12 on 2022-03-10 22:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_trips', models.CharField(blank=True, choices=[('None', 'None'), ('Class visits (museums, art galleries, etc.)', 'Class visits (museums, art galleries, etc.)'), ('Extensive trips (quarry, archaeological site, etc.)', 'Extensive trips (quarry, archaeological site, etc.)')], max_length=60, null=True)),
