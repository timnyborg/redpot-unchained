...
urlpatterns = [
    ...
    path('previewquestions', views.PreviewQuestionnaireView.as_view(), name='previewquestions'),
    path('feedback_request', views.FeedbackRequestView.as_view(), name='feedbackrequest'),
